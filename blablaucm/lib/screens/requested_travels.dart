...
class RequestedTravelsScreen extends StatefulWidget {
  const RequestedTravelsScreen({super.key});

  @override
  State<RequestedTravelsScreen> createState() => _RequestedTravelsScreenState();
}

class _RequestedTravelsScreenState extends State<RequestedTravelsScreen> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => RequestedTravelsDetailsScreen(travel: t),
          ),
        );
      },
      child: Card(
